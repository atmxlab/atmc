...
`
	...
	expectedAst := ast2.NewAst(
		ast2.NewFile(
			[]ast2.Import{
				ast2.NewImport(
					ast2.NewIdent("common", types.NewLocation(
						types.NewPosition(2, 1, 2),
						types.NewPosition(2, 7, 8),
					)),
					ast2.NewPath("./dir/common.atmc", types.NewLocation(
						types.NewPosition(2, 8, 9),
						types.NewPosition(2, 25, 26),
					)),
				),
				ast2.NewImport(
					ast2.NewIdent("kafka", types.NewLocation(
						types.NewPosition(3, 1, 28),
						types.NewPosition(3, 6, 33),
					)),
					ast2.NewPath("./dir/kafka.atmc", types.NewLocation(
						types.NewPosition(3, 7, 34),
						types.NewPosition(3, 23, 50),
					)),
				),
				ast2.NewImport(
					ast2.NewIdent("abs", types.NewLocation(
						types.NewPosition(4, 1, 52),
						types.NewPosition(4, 4, 55),
					)),
					ast2.NewPath("/dir/abs.atmc", types.NewLocation(
			...
			ast2.NewObject(
				[]ast2.Entry{
					...
					ast2.NewKV(
						ast2.NewIdent("int", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("float", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("bool1", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("bool2", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("string", types.NewLocation(
							types.NewPosition(12, 2, 145),
							types.NewPosition(12, 8, 151),
						)),
						ast2.NewString(`test string \"escaped`, types.NewLocation(
					...
					ast2.NewSpread(
						ast2.NewVar([]ast2.Ident{
							...
							ast2.NewIdent("nested", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("object1", types.NewLocation(
							...
							[]ast2.Entry{
								ast2.NewSpread(
									ast2.NewVar([]ast2.Ident{
										...
										ast2.NewIdent("field", types.NewLocation(
								...
								ast2.NewKV(
									ast2.NewIdent("field1", types.NewLocation(
								...
								ast2.NewKV(
									ast2.NewIdent("field2", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("array1", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("envVar", types.NewLocation(
							types.NewPosition(25, 2, 329),
							types.NewPosition(25, 8, 335),
						)),
						ast2.NewEnv(
							ast2.NewIdent("POSTGRES_PASSWORD", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("arrayWithComma", types.NewLocation(
							types.NewPosition(26, 2, 358),
							types.NewPosition(26, 16, 372),
						)),
						ast2.NewArray(
							[]ast2.Expression{
								ast2.NewString(`test text`, types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("arrayWithoutComma", types.NewLocation(
					...
					ast2.NewKV(
						ast2.NewIdent("arrayWithEnv", types.NewLocation(
						...
						ast2.NewArray(
							[]ast2.Expression{
								ast2.NewEnv(
									ast2.NewIdent("POSTGRES_HOST", types.NewLocation(
								...
								ast2.NewEnv(
									ast2.NewIdent("POSTGRES_DATABASE", types.NewLocation(
